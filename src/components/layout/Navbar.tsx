...
export function Navbar() {
  ...
  return (
    <>
      {/* Announcement Bar */}
      <div className="announcement-bar border-b border-amber-200 px-4 py-2 text-center">
        <p className="text-xs text-amber-800 font-medium">
          ⚠️ All creatives generated by this app must be reviewed and approved by the Marketing team before being used in any campaign or published externally.
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            <div className="text-right hidden sm:block">
              <p className="text-xs font-semibold text-gray-800">
                Vishnusingh Vijaysingh Chundawat (DigitalJSC)
              </p>
              <p className="text-xs text-gray-500">V.CHUNDAWAT@goIndiGo.in</p>
            </div>
